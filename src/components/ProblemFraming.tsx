...
export const ProblemFraming: React.FC = () => {
  ...
  return (
    <section id="leakage" className="py-20 md:py-32 bg-[#08080A] border-t border-white/10 relative">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-[#0D0D0F] border border-white/10 rounded-xl p-6 md:p-8">
            ...
            <div className="p-6 bg-black/40 border border-white/10 rounded-lg">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <div className="text-2xl md:text-3xl font-semibold text-red-400">
                    ₹{monthlyUnbilledLoss.toLocaleString('en-IN')}
                  </div>
                  <div className="text-xs text-arena-subtle mt-1">
              ...
              {/* Total Bleed Metric */}
              <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row sm:items-baseline justify-between gap-3">
                <div>
                  <div className="text-xs text-white flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-400" />
                    Total capital vanishing annually
                  </div>
                  <div className="text-3xl sm:text-4xl md:text-5xl font-semibold text-white tracking-tight mt-1">
                    ₹{annualBleed.toLocaleString('en-IN')}
                    <span className="text-sm text-arena-muted ml-2 font-normal">/ year</span>
                  </div>
                </div>
