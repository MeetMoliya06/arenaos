...
export const Hero: React.FC<HeroProps> = ({ onOpenDemo }) => {
  return (
    <section className="relative pt-28 md:pt-36 pb-16 md:pb-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            {/* System Status Tag */}
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/[0.03] border border-white/10 rounded-full text-xs text-arena-muted mb-6 w-fit">
              <span className="w-1.5 h-1.5 rounded-full bg-arena-lime" />
              <span>Zero-leakage engine, live in production</span>
            </div>

            {/* Headline */}
            <h1 className="font-semibold text-4xl sm:text-5xl md:text-6xl leading-[1.05] tracking-tight text-white mb-6">
              Every PC. Every rupee.<br />
              One dashboard.
            </h1>

            {/* Copy */}
            <p className="text-base sm:text-lg text-arena-muted max-w-xl mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-10">
              <button
                ...
                className="px-5 py-3 bg-arena-lime text-black font-medium text-sm rounded-md transition-colors hover:bg-arena-limeBright flex items-center gap-2 active:scale-[0.98]"
              >
              ...
              <a
                href="#leakage"
                onClick={() => playClick()}
                className="px-5 py-3 border border-white/10 hover:border-white/20 text-white text-sm rounded-md transition-colors bg-white/[0.02] hover:bg-white/[0.05] flex items-center gap-2"
              >
      ...
      {/* Live event strip */}
      <div className="mt-14 md:mt-20 border-y border-white/10 py-3 overflow-hidden text-sm">
